...
let productsData = [
    ...
    },
    {
        ...
        description: "Top in soft cotton jersey with a round, rib-trimmed neckline. Relaxed fit with dropped shoulders, long sleeves and wide ribbing at the cuffs.",
        categories: "T-Shirts",
        sizes: ["XS", "S", "M", "L", "XL"],
        price: 27.99,
        img: [
    ...
    },
    {
        ...
        description: "Edition by John Boyega. An uncompromising collection made from more sustainable materials developed together with actor and innovator, John Boyega. These 5-pocket jeans in sturdy denim made from recycled cotton have a regular waist, zip fly and button and loose-fitting legs.",
        categories: "Pants",
        sizes: ["XS", "S", "M", "L", "XL"],
        price: 39.99,
        img: [
    ...
    {
        name: "Skinny Jeans",
        description: "5-pocket jeans in stretch cotton denim with a regular waist, zip fly and button, and skinny legs.",
        categories: "Pants",
        sizes: ["XS", "S", "M", "L", "XL"],
        price: 17.99,
        img: [
    ...
    {
        name: "Loose Jeans",
        description: "5-pocket jeans in sturdy cotton denim. Loose fit with a regular waist, zip fly and button and wide legs.",
        categories: "Pants",
        sizes: ["XS", "S", "M", "L", "XL"],
        price: 24.99,
        img: [
    ...
    },
    {
        ...
        description: "Toga Archives x H&M. A collection of classic, iconic pieces from Tokyo-based TOGA. Wardrobe classics characterised by innovative details and functions, defined by a gender-neutral, individual approach to fashion. A pair of brogues in leather with perforated details and an extended shaft in scuba fabric. Open lacing at the front and a chunky zip with a metal ring pull at the back. Leather linings and insoles and rubber soles.",
        categories: "Shoes",
        sizes: ["XS", "S", "M", "L", "XL"],
        price: 199.99,
        img: [
    ...
    },
    {
        ...
        description: "DERBIES WITH AN ALMOND TOE AND A SINGLE MONK STRAP WITH METAL BUCKLE.",
        categories: "Shoes",
        sizes: ["XS", "S", "M", "L", "XL"],
        price: 394.99,
        img: [
    ...
    },
    {
        ...
        description: "The Bryson combines the refined styling of a Chelsea boot with the durability of a rubber lug sole. This sophisticated shoe features an oiled suede upper accented with a woven logo pull tab at the heel.",
        categories: "Shoes",
        sizes: ["XS", "S", "M", "L", "XL"],
        price: 199.99,
        img: [
    ...
    },
    {
        ...
        description: "Cotton sneakers in Vintage check, printed with our refreshed logo in contrasting tones.",
        categories: "Shoes",
        sizes: ["XS", "S", "M", "L", "XL"],
        price: 249.99,
        img: [
